...
public class ConditionalEffectToCPFS_JAVA {
    Condition condition;
    ...
    public ConditionalEffectToCPFS_JAVA(Effect conditionalEffect, Predicate _stateVariablePredicate, PlanningStateVariable _effectedStateVariable)
    {
    ...
    public Triplet<String> GetCPFS_Parts_JAVA(PLP plp) throws Exception {
        ...
        res.First = PLP2JavaUtils.GetVariablesAssignments(stateVariablePredicate.Params.toArray(new PlanningTypedParameter[stateVariablePredicate.Params.size()]));
        ...
        String conditionIf = condition == null ? "" : condition.condition.getConditionForIf_JavaNextState(stateVariablePredicate.Params, false, effectedStateVariable.IsObservation);
